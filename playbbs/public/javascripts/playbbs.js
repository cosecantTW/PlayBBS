var Comment = React.createClass({
    ...
    render: function() {
        ...
        return ( < div className = "comment" >
            ...
            < button className = "btn btn-primary" > Edit < /button> < button className = "btn btn-danger"
            onClick = {
                this.props.onCommentDelete.bind(null, this.props.index, this.props.id)
            } > Delete < /button> < /form> < /h3> < /div>
        );
    }
});
...
var CommentBox = React.createClass({
    ...
    render: function() {
        return ( < div className = "commentBox" >
            < h1 > Comments < /h1> < CommentForm onCommentSubmit = {
...
var CommentList = React.createClass({
    render: function() {
        ...
        var commentNodes = this.props.data.map(function(comment, index) {
            ...
            return ( < Comment onCommentDelete = {
                    onCommentDelete
                }
                name = {
                    comment.name
...
var CommentForm = React.createClass({
    ...
    render: function() {
        return ( < form className = "commentForm form-inline"
            onSubmit = {
                this.handleSubmit
            } >
            < input type = "text"
            ...
            value = "Post" > Submit < /button> < button className = "btn btn-warning"
            onClick = {
